...
\begin{center}
	...
	\begin{tikzpicture}[
			MARKED/.style={fill=purple, circle, inner sep=2pt},
			BP/.style={fill=orange, circle, inner sep=2pt},
			SPECIAL/.style={fill=red, circle, inner sep=2pt},
			NORMAL/.style={fill=black, circle, inner sep=2pt}
		]
		\node[NORMAL] (root) {}
		...
		\node at (4, -8) {
			\begin{tblr}{|cl|}
				\hline
				\textcolor{purple}{$\blacksquare$} & Nodi marcati \\
				\textcolor{red}{$\blacksquare$} & Nodi speciali \\
				\textcolor{orange}{$\blacksquare$} & Branch point \\
				\hline
			\end{tblr}
		};
	\end{tikzpicture}
